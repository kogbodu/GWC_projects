...
ball= BouncingBall2(350,250,10,2,30)
...
possible_ball_colors2=[BLACK, WHITE, GREEN, RED, BLUE, GREY]
...
ball_size2 = random.randint(10, 30)
...
while not done:
	...
	ball_color2 = random.choice(possible_ball_colors
